...
def topology():
    ...
    info("*** Creating nodes\n")
    sta1 = net.addStation('sta1', mac='00:00:00:00:00:11',ip='192.168.1.1/24', position='20,51,0')
    sta2 = net.addStation('sta2', mac='00:00:00:00:00:12',ip='192.168.1.2/24', position='51,51,0')
    sta3 = net.addStation('sta3', mac='00:00:00:00:00:13',ip='192.168.1.3/24', position='81,51,0')
    sta4 = net.addStation('sta4', mac='00:00:00:00:00:14',ip='192.168.1.4/24', position='105,51,0')
    sta5 = net.addStation('sta5', mac='00:00:00:00:00:15',ip='192.168.1.5/24', position='125,51,0')
    sta6 = net.addStation('sta6', mac='00:00:00:00:00:16',ip='192.168.1.6/24', position='155,51,0')
    ...
    ap5 = net.addAccessPoint('ap5', wlans=2, ssid='ssid5', position='130,60,0')
    ap6 = net.addAccessPoint('ap6', wlans=2, ssid='ssid6', position='160,60,0')
