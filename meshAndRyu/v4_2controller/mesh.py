...
def topology():
    ...
    c0 = net.addController('c0', controller=Controller, port=6652)
    # c0.cmd('ryu-manager --ofp-tcp-listen-port 6652 ryu.app.ofctl_rest')
    c1 = net.addController('c1', controller=RemoteController, ip='127.0.0.1', port=6653)
    s1 = net.addSwitch('s1', cls=OVSKernelSwitch) #one way gateway
